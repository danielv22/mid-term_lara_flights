...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="alert alert-info text-center">Crear nuevo vuelo</h1>
            </div>
            <div class="col-12">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input type="number" id="fl_distance" name="fl_distance" class="form-control"
                                   aria-describedby="addon_cow_height" value="{{ old('fl_distance')  }}">
